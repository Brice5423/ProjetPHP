    ...
    <from method="post" action = "accueil.php">
        <header>
            ...
            <nav class="inscrit">
                <ul>
                    <li class="inscrit">
                        <a href="http://localhost/PHP_Projet/Projet/Site_Web/src/creerCompte.php">Sign In</a>
                    </li>
                    <li class="connect">
                        <a href="http://localhost/PHP_Projet/Projet/Site_Web/src/seConnecter.php">Log In</a>
                    </li>
                </ul>
            </nav>
        </header>
            ...
            <div class="container">
                ...
                <div class="slider">
                    ...
                    <figure>
                        ...
                        <figcaption>Genshin Impact est arrivé sur PC et Console</figcaption>
                    </figure>
                </div>
            </div>
